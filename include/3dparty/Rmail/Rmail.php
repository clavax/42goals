        ...
        switch ($type) {
            case 'mail':
                ...
                if (!empty($this->return_path)) {
                    $result = email::send($to, $subject, $this->output, implode(RMAIL_CRLF, $headers), '-f' . $this->return_path);
                } else {
                    $result = email::send($to, $subject, $this->output, implode(RMAIL_CRLF, $headers));
                }
